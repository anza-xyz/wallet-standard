...
import { getOrCreateReactWalletForStandardWallet_INTERNAL_ONLY_NOT_FOR_EXPORT } from '../WalletRegistry_INTERNAL_ONLY_NOT_FOR_EXPORT.js';
...
describe('getOrCreateReactWalletForWalletHandle_INTERNAL_ONLY_NOT_FOR_EXPORT', () => {
    ...
    it('returns a frozen object', () => {
        const reactWallet = getOrCreateReactWalletForStandardWallet_INTERNAL_ONLY_NOT_FOR_EXPORT(mockWallet);
    ...
    it('returns the same React wallet given the same underlying Standard wallet', () => {
        const reactWalletA = getOrCreateReactWalletForStandardWallet_INTERNAL_ONLY_NOT_FOR_EXPORT(mockWallet);
        const reactWalletB = getOrCreateReactWalletForStandardWallet_INTERNAL_ONLY_NOT_FOR_EXPORT(mockWallet);
