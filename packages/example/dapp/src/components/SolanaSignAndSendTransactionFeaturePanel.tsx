...
import { useTransactionSendingSigner } from '@solana/react';
import {
    address,
...
import { getUiWalletAccountStorageKey, useWallets, type UiWalletAccount } from '@wallet-standard/react';
...
export function SolanaSignAndSendTransactionFeaturePanel({ account }: Props) {
    ...
    const transactionSendingSigner = useTransactionSendingSigner(account, currentChain, {
            ...
            >
                <Box flexGrow="1" overflow="hidden">
                    <Flex gap="3" align="center">
                        ...
                        >
                            <Select.Trigger
                                style={{ flexShrink: 1, overflow: 'hidden', flexGrow: 1 }}
                    ...
                    {lastSignature ? (
                        ...
                        >
                            ...
                            <Flex direction="column" gap="2">
                                ...
                                <Text>
                                    <Link
                                        href={`https://explorer.solana.com/tx/${getBase58Decoder().decode(lastSignature)}?cluster=${solanaExplorerClusterName}`}
                                        target="_blank"
                                    >
